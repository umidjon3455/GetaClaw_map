...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Not really. Get a Claw automates the entire process. You'll need to create accounts on a VPS provider (Hetzner or DigitalOcean) and an AI model provider (OpenRouter), but we guide you through every step. The setup wizard adapts to your skill level.",
  },
  {
    question: "How much does it cost?",
    answer:
      "Get a Claw itself is free and open source. You'll pay for a VPS (starting at ~$4/month on Hetzner) and AI model usage through OpenRouter (pay-per-use, typically a few dollars per month for personal use).",
  },
  {
    question: "Is my data really private?",
    answer:
      "Yes. Your OpenClaw instance runs entirely on your own VPS. Get a Claw never stores your API keys, server credentials, or any personal data on our servers. The website is open source — you can verify this yourself. Even the thin API proxy we use for VPS creation is stateless and stores nothing.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. Come back to Get a Claw anytime to check your instance's health, update OpenClaw to the latest version, add or remove messaging channels, and change configuration — all from your browser.",
  },
  {
