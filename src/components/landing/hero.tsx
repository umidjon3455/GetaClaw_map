  ...
  return (
    <section className="relative overflow-hidden px-5 pb-20 pt-24 sm:px-8 sm:pb-28 sm:pt-32">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -right-32 -top-32 h-[500px] w-[500px] rounded-full bg-gradient-to-br from-coral/8 to-coral-200/5 blur-3xl dark:from-coral/15 dark:to-coral-500/5" />
      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a
            href="/setup"
            className="inline-flex items-center justify-center rounded-[var(--radius-md)] bg-coral px-6 py-3 text-base font-semibold text-white shadow-lg shadow-coral/25 transition-all hover:bg-coral-hover hover:shadow-xl hover:shadow-coral/30 active:bg-coral-active"
          >
            Get Started
